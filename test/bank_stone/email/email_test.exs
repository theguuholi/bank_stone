defmodule BankStone.Email.EmailTest do
  ...
  test "withdraw_email " do
    ...
    assert email.html_body =~ "<strong>Joelma</strong><p>Withdraw Amount: 100</p><p>New Balance: 100000</p>"
  ...
  test "the user gets a withdraw email " do
    ...
    expected_email = BankStone.Email.Email.withdraw_email(account, 100)
